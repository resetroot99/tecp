 ...
 */
export class NoNetworkEnforcer {
    policyId = 'no_network';
    async enforce(input, context) {
...
export class PolicyRuntime {
    ...
    async enforcePolicy(policyId, input, context) {
    ...
    async enforcePolicies(policyIds, input, context) {
